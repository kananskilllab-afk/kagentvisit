...
import { 
    ...
    MapPin, Calendar, 
    ChevronRight, ChevronLeft, Loader2, X, Edit2, Trash2, Shield, Upload
} from 'lucide-react';
...
const AgentRow = React.memo(({ agent, onEdit, onDelete }) => (
        ...
        <div className="space-y-6 page-enter pb-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                ...
                <div className="flex items-center gap-2 bg-white p-1.5 rounded-2xl shadow-sm border border-slate-100">
                    ...
                    <button onClick={() => setShowImportModal(true)} className="flex items-center gap-2 px-3.5 py-2.5 rounded-xl border border-slate-200 text-slate-500 font-bold text-xs hover:bg-slate-50 transition-colors" title="Bulk Import">
                        <Upload className="w-4 h-4" />Import
                    </button>
                    <button onClick={() => { setEditingAgent(null); setShowRegisterModal(true); }} className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 text-white font-bold text-xs shadow-xl shadow-slate-900/20 hover:bg-slate-800 transition-colors">
            ...
            <div className="card p-0 overflow-hidden">
                {/* Toolbar */}
                <div className="p-4 sm:p-5 border-b border-slate-100 bg-slate-50/50 flex flex-col xl:flex-row gap-4 justify-between items-center">
                ...
                {/* Pagination footer */}
                <div className="p-4 border-t border-slate-50 flex items-center justify-between text-xs font-bold text-slate-400">
